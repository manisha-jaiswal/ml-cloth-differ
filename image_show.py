...
class_names=['T-shirt/top','Trouser','Fullover','Dress','Coat','Sandal','Shirt','Sneaker','BAg','Ankle-Boot']
...
#model=tf.keras.models.Sequential([tf.keras.layers.Flaten(input_shape=(28,28)),tf.keras.layers.Dense(128,activation='relu'),(tf.keras.layers.Dense(10,activation="Softmax")])
...
#step 8 here we compare the output with the image labels ,epochs is nothing but it is iteration,
